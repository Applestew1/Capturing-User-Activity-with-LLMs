...
#Takes the dimensions of the specified window and saves screenshots to the downloads folder
...
def monitor_application(interval=2):
    ...
    while monitoring:
        screenshot_path = screenshot(app_name)
        if screenshot_path:
            ...
            "messages": [
                {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": "use the screenshots for context and provide a DETAILED answer to the question" + prompt
                        }
                    ] + image_messages
                }
            ],
